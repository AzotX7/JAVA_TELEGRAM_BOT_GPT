...
import com.azot.telegram_bot.telegram.handler.TelegramUpdateMessageHandler;
...
public class TelegramBot extends TelegramLongPollingBot {
    ...
    public TelegramBot(@Value("${bot.token}") String botToken,TelegramUpdateMessageHandler telegramUpdateMessageHandler) {
